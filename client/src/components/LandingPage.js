...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="loci-bg py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            <div className="flex-1">
              <div className="loci-container p-4 transform hover:scale-105 transition-transform duration-300">
                <img
                  src={logo}
                  alt="Loci Memory Palace"
