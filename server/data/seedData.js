const seedData = {
  ...
  spanishVocabulary: {
    ...
    associations: [
      ...
      {
        anchor: "dais",
        memorable: "el trono (the throne platform)",
        description: "A raised dais supporting the royal throne"
      },
      {
        anchor: "column",
        memorable: "la columna (the column)",
  ...
  programmingConcepts: {
    ...
    associations: [
      ...
      },
      {
        anchor: "dais",
        memorable: "Database",
        description: "A dais with data structures and tables"
      },
      {
        anchor: "column",
        memorable: "Stack",
        description: "A column with data stacked vertically"
      }
    ]
  },
  ...
  businessConcepts: {
    ...
    associations: [
      ...
      {
        anchor: "dais",
        memorable: "Strategic Planning",
        description: "A dais with roadmap and business objectives"
      },
      {
        anchor: "column",
        memorable: "Team Structure",
        description: "A column representing organizational hierarchy"
      }
    ]
  },
